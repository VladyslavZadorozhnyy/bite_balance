...
public final class CheckboxBinding implements ViewBinding {
  ...
  private CheckboxBinding(@NonNull View rootView, @NonNull FrameLayout checkbox,
  ...
  public static CheckboxBinding inflate(@NonNull LayoutInflater inflater,
    ...
    inflater.inflate(R.layout.checkbox, parent);
    return bind(parent);
  }
  ...
  public static CheckboxBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.checkbox;
      FrameLayout checkbox = ViewBindings.findChildViewById(rootView, id);
      if (checkbox == null) {
        break missingId;
      }
      ...
      return new CheckboxBinding(rootView, checkbox, imageView);
    }
